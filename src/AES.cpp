...
void AES::Subbytes(uint32_t *input)
{
    for (int c = 0; c < 4; c++)
    {
        input[c] = ((Sbox[input[c] >> 24 & 0xFF]) << 24) + ((Sbox[input[c] >> 16 & 0xFF]) << 16) + ((Sbox[input[c] >> 8 & 0xFF]) << 8) + (Sbox[input[c] & 0xFF]);
    }
}
...
void AES::invSubbytes(uint32_t *input)
{
    for (int c = 0; c < 4; c++)
    {
        input[c] = ((invSbox[input[c] >> 24 & 0xFF]) << 24) + ((invSbox[input[c] >> 16 & 0xFF]) << 16) + ((invSbox[input[c] >> 8 & 0xFF]) << 8) + (invSbox[input[c] & 0xFF]);
    }
}
...
void AES::Mixcolumns(uint32_t *input)
{
    ...
    {
        input[c] =
            ((mul2[(input[c] >> 24) & 0xFF] ^ mul3[(input[c] >> 16) & 0xFF] ^ ((input[c] >> 8) & 0xFF) ^ (input[c] & 0xFF)) << 24) +
            ((((input[c] >> 24) & 0xFF) ^ mul2[(input[c] >> 16) & 0xFF] ^ mul3[(input[c] >> 8) & 0xFF] ^ (input[c] & 0xFF)) << 16) +
            ((((input[c] >> 24) & 0xFF) ^ ((input[c] >> 16) & 0xFF) ^ mul2[(input[c] >> 8) & 0xFF] ^ mul3[input[c] & 0xFF]) << 8) +
            (mul3[(input[c] >> 24) & 0xFF] ^ ((input[c] >> 16) & 0xFF) ^ ((input[c] >> 8) & 0xFF) ^ mul2[input[c] & 0xFF]);
    }
}
...
void AES::invMixcolumns(uint32_t *input)
{
    ...
    {
        input[c] =
            ((mul14[(input[c] >> 24) & 0xFF] ^ mul11[(input[c] >> 16) & 0xFF] ^ mul13[(input[c] >> 8) & 0xFF] ^ mul9[input[c] & 0xFF]) << 24) +
            ((mul9[(input[c] >> 24) & 0xFF] ^ mul14[(input[c] >> 16) & 0xFF] ^ mul11[(input[c] >> 8) & 0xFF] ^ mul13[input[c] & 0xFF]) << 16) +
            ((mul13[(input[c] >> 24) & 0xFF] ^ mul9[(input[c] >> 16) & 0xFF] ^ mul14[(input[c] >> 8) & 0xFF] ^ mul11[input[c] & 0xFF]) << 8) +
            (mul11[(input[c] >> 24) & 0xFF] ^ mul13[(input[c] >> 16) & 0xFF] ^ mul9[(input[c] >> 8) & 0xFF] ^ mul14[input[c] & 0xFF]);
    }
}
